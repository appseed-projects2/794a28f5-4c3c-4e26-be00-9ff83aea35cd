...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 09:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/794a28f5-4c3c-4e26-be00-9ff83aea35cd.git
$ cd 794a28f5-4c3c-4e26-be00-9ff83aea35cd
```
